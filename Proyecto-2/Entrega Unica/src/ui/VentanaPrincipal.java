...
public class VentanaPrincipal extends JFrame {
    ...
    public VentanaPrincipal(Cafe cafe) {
        ...
        // Panel de login (se mostrará después de seleccionar rol)
  ...
  /*  
    private JPanel crearPanelSeleccion() {
        ...
        btnCliente.addActionListener(e -> {new VentanaCliente(cafe).setVisible(true);});
        gbc.gridy = 1;
        gbc.gridwidth = 1;
    ...
    private JPanel crearPanelSeleccion() {
        ...
        // Botón Cliente - Abre directamente VentanaCliente
        JButton btnCliente = new JButton(" Cliente");
        btnCliente.setPreferredSize(new Dimension(150, 40));
