...
public class PanelPrestamosCliente extends JPanel {
    ...
    private void solicitarPrestamo() {
        ...
        // para los multiples errores que salian
        for (JuegoFisico juego : juegosSeleccionados) {
            ...
            if (prestamo != null) {
                resultado.append("Correcto ").append(juego.getJuegoBase().getNombre()).append("\n");
            } else {
                resultado.append("Error ").append(juego.getJuegoBase().getNombre()).append(" (ver consola para detalles)\n");
                todosExitosos = false;
            }
        }
